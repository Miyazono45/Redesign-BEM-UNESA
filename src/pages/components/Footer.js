  ...
  return (
    <div
      ...
      className={`bg-white mt-10 animate-fade-up ${
        isVisible ? "is-visible is-entering" : ""
      }`}
      style={{
        ...
        <div className="bottom-0">
          ...
          <div className="flex flex-row">
            ...
            <div className="mt-[245px] text-gray-800 flex flex-col z-40 ml-[125px]">
              <p className="text-[#1F183C] font-extrabold text-[1.5em]">Email:</p>
              <p className="font-medium -mt-2 text-[1.0em]">bem@unesa.ac.id</p>
              <p className="text-[#1F183C] font-extrabold text-[1.5em]">Hubungi Kami:</p>
              <p className="font-medium -mt-2 text-[1.0em]">Feby : +6281254155827</p>
              <p className="text-[#1F183C] font-extrabold text-[1.5em]">Seketariat BEM UNESA:</p>
              <p className="font-medium -mt-2 text-[1.0em]">Jl. Unesa, Kota Surabaya</p>
            </div>
          </div>
        </div>
      </div>
